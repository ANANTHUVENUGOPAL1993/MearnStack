var countries=[
  ...
  var country_data={}
  var count=0;
  console.log(countries[0].languages[0].name);
...
function getCountryDataByName(country_name){
    ...
    return country_name in country_data?country_data[country_name]:"invalid data"
...
function getCurrencyByName(country_name){
    return country_name in country_data?country_data[country_name].currency:"invalid country name"
}

console.log( getCurrencyByName("India"));